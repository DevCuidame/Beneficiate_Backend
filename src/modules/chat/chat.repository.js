...
const createMessage = async (chat_id, sender_id, sender_type, message, status) => {
    const result = await pool.query(
        'INSERT INTO messages (chat_id, sender_id, sender_type, message, status) VALUES ($1, $2, $3, $4, $5) RETURNING *',
        [chat_id, sender_id, sender_type, message, status]
    );
