...
const getByBeneficiaryId = async (req, res) => {
  try {
    ...
    const records = await service.getByBeneficiaryId('beneficiary_diseases', beneficiary_id);
...
const createRecord = async (req, res) => {
  try {
    const record = await service.createRecord('beneficiary_diseases', req.body);
...
const updateRecord = async (req, res) => {
  try {
    const { id } = req.params;
    const updatedRecord = await service.updateRecord('beneficiary_diseases', id, req.body);
...
const removeRecord = async (req, res) => {
  try {
    const { id } = req.params;
    await service.removeRecord('beneficiary_diseases', id);
