    ...
    <div class="container">
      ...
      <div class="content">
        <div class="info-contain">
          ...
          <p class="description">Hola <strong>${beneficiaryForm.beneficiary.name}</strong>,</p>

          <p class="description">
            Has sido registrado como beneficiario en la plataforma, gracias a la
            membresía activa de <strong>${beneficiaryForm.name}</strong>.
          </p>
          ...
          <p class="description">
            Usuario: <strong>${beneficiaryForm.beneficiary.email}</strong><br />
            Contraseña temporal: <strong>${beneficiaryForm.beneficiary.password}</strong>
          </p>
